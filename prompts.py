...
def build_prompt(article: Article, profile_text: str, *, attachments_included: bool = False) -> str:
    """공지 하나를 독립적으로 분석하는 입력을 만든다."""
    today = datetime.now(_KST).date().isoformat()
    description = article.description[:PROMPT_DESCRIPTION_MAX_LENGTH].strip() or "본문 없음"
